                ...
                <div class="flex items-center space-x-6 lg:space-x-8">
                  <div class="grid flex-shrink-0 grid-cols-1 gap-y-6 lg:gap-y-8">
                    <div class="h-64 w-44 overflow-hidden rounded-lg sm:opacity-0 lg:opacity-100">
                      <img src="/images/1.jfif" alt="1" class="h-full w-full object-cover" />
                    </div>
                    <div class="h-64 w-44 overflow-hidden rounded-lg">
                      <img src="/images/2.jfif" alt="1" class="h-full w-full object-cover" />
                    </div>
                  </div>
                  <div class="grid flex-shrink-0 grid-cols-1 gap-y-6 lg:gap-y-8">
                    <div class="h-64 w-44 overflow-hidden rounded-lg">
                    ...
                    <div class="h-64 w-44 overflow-hidden rounded-lg">
                      <img src="/images/3.jfif" alt="1" class="h-full w-full object-cover" />
                    </div>
                    <div class="h-64 w-44 overflow-hidden rounded-lg">
                      <img src="/images/1.jfif" alt="1" class="h-full w-full object-cover" />
                    </div>
                  ...
                  <div class="grid flex-shrink-0 grid-cols-1 gap-y-6 lg:gap-y-8">
                    <div class="h-64 w-44 overflow-hidden rounded-lg">
                      <img src="/images/4.jfif" alt="1" class="h-full w-full object-cover" />
                    </div>
                    <div class="h-64 w-44 overflow-hidden rounded-lg">
                      <img src="/images/5.jfif" alt="1" class="h-full w-full object-cover" />
                    </div>
                  </div>
                </div>
              </div>
